...
import com.example.firebasechat.AdapterMensajes;
import com.example.firebasechat.Entidades.MensajeEnviar;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = database.getReference("chatV2"); //Nodo principal, Sala de chat (nombre) version 2
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK){
            ...
            fotoReferencia.putFile(u).addOnSuccessListener(this, new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    MensajeEnviar m = new MensajeEnviar(NOMBRE_USUARIO+" ah actualizado su foto de perfil",u.toString(),NOMBRE_USUARIO,fotoPerfilCadena,"2",ServerValue.TIMESTAMP);
                    databaseReference.push().setValue(m);
                    //Error glide--------------------------------------------------------------------------------------------------------------!!
